...
class Sort {
    ...
    /* 
       ...
       splits the list n into two halves, reference to the head of the 
       smaller half (in case of odd length) is returned and n will refer 
       to larger half 
    */
    ...
    */
    public static ListNode mergeSort (ListNode n)
    {
		...
		if(split == null){
			...
			var leftList = mergeSort(n);
			var rightList = mergeSort(split);
